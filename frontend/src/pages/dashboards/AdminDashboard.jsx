...
export default function AdminDashboard({ onRoleSwitch }) {
          ...
          {[
            {
              ...
              bg: "bg-emerald-50",
              ic: "stroke-emerald-500",
              icon: "users",
            },
            {
              label: "Active Doctors",
              value: DOCTORS.filter((d) => d.status === "Active").length,
              change: `${DOCTORS.filter((d) => d.status === "On Leave").length} on leave`,
              bg: "bg-blue-50",
              ic: "stroke-blue-500",
              icon: "stethoscope",
            },
            {
              ...
              change: `${confirmedToday} confirmed`,
              bg: "bg-violet-50",
              ic: "stroke-violet-500",
              icon: "calendar",
            },
            {
              ...
              <table className="w-full min-w-[420px]">
                <thead>
                  <tr className="border-b border-gray-100">
                    {["Patient", "Condition", "Doctor", "Status"].map((h) => (
                      <th
                        key={h}
          ...
          <Card>
            ...
            <div className="overflow-x-auto">
              <table className="w-full min-w-[420px]">
                <thead>
                  <tr className="border-b border-gray-100">
                    {["Doctor", "Specialty", "Patients", "Status"].map((h) => (
                      <th
                        key={h}
                        className="text-left text-xs text-gray-400 font-medium uppercase tracking-wider px-5 py-3"
                      >
              ...
              >
                ...
                <div className="space-y-2 text-xs mb-4">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-gray-700">{p.blood}</span>
                  </div>
                  <div className="flex justify-between">
          ...
          {DOCTORS.map((d) => {
            ...
            return (
              ...
              >
                ...
                <div className="text-xs text-gray-400 truncate pt-3 border-t border-gray-100">
                  {d.email}
                </div>
              </Card>
            );
  ...
  return (
    <DashboardShell
      ...
      accent={accent}
      logo="Admin Console"
      profile={{ name: "Admin", initials: "AD", sub: "System Administrator" }}
